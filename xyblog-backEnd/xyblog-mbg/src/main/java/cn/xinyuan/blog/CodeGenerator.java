...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");//意思是读取当前用户的工作目录
        gc.setOutputDir(projectPath + "/xyblog-mbg/src/main/java/");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/xyblog-mbg/src/main/resources/mapper/" + "xml"
